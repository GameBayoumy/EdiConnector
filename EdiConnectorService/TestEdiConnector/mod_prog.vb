...
Module mod_prog
    ...
    Public Function Connect_to_Sap() As Integer
        ...
        Try
            ...
            With cmp
                ...
                .UseTrusted = False
                .LicenseServer = strLicenseServer
                ret = .Connect()
    ...
    Public Function ReadSettings() As Integer
        ...
        Try
            ...
            '' MessageBox.Show(Application.StartupPath, "ok")
            ...
            strLicenseServer = ds.Tables("server").Rows(0).Item("licenseserver")
    ...
    Public Function ReadInterface() As Integer
        ...
        Dim ds As New DataSet
        ds.ReadXml(Application.StartupPath & "\orderfld.xml")
    ...
    Public Function Log(ByVal sType As String, ByVal msg As String, ByVal FunctionSender As String) As Integer
        ...
        Using fs As New StreamWriter(Application.StartupPath & "\log.txt", True)
    ...
    Public Function View_log() As Integer
        ...
        If File.Exists(Application.StartupPath & "\log.txt") = True Then
    ...
    Public Function CreateUdfFiledsText() As Integer
        ...
        ''MessageBox.Show(Application.StartupPath & "\udf.xml")
        If File.Exists(Application.StartupPath & "\udf.xml") = False Then
            Return 0
            Exit Function
        End If

        Dim ds As New DataSet
        ds.ReadXml(Application.StartupPath & "\udf.xml")
        ...
        Try
            Using mailMsg As New Mail.MailMessage()
                ...
                With mailMsg
                    ...
                    Using rFile As New StreamReader(Application.StartupPath & "\email_o.txt")
                        Dim sBody As String
        ...
        Try
            Using mailMsg As New Mail.MailMessage()
                ...
                With mailMsg
                    ...
                    Using rFile As New StreamReader(Application.StartupPath & "\email_d.txt")
                        Dim sBody As String
                        sBody = rFile.ReadToEnd()
        ...
        Try
            Using mailMsg As New Mail.MailMessage()
                ...
                With mailMsg
                    ...
                    Using rFile As New StreamReader(Application.StartupPath & "\email_i.txt")
                        Dim sBody As String
                        sBody = rFile.ReadToEnd()
